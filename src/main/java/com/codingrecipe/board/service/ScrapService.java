...
public class ScrapService {
    ...
    public void addScrap(String email, Long boardId) { // 변경: userId -> email
    ...
    public void removeScrap(String email, Long boardId) { // 변경: userId -> email
        // 변경: findByUserId -> findByEmail
        Member member = memberRepository.findByEmail(email)
                .orElseThrow(() -> new IllegalArgumentException("사용자를 찾을 수 없습니다."));
        BoardEntity board = boardRepository.findById(boardId)
    ...
    public List<BoardDTO> getMyScraps(String email) { // 변경: userId -> email
        // 변경: findByUserId -> findByEmail
        Member member = memberRepository.findByEmail(email)
                .orElseThrow(() -> new IllegalArgumentException("사용자를 찾을 수 없습니다."));
