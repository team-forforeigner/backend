...
(2, 1, 2, '👍 에피소드 2. 좋아! 이제 축제에 가기 전 장소를 확인하고 준비물을 챙기자', JSON_ARRAY('🧭 진해 군항제: 경상남도 창원시 진해구 일대', '🧭 여의도 벚꽃축제: 서울 영등포구 여의도 윤중로', '', '🎒 준비물: 마실 물, 카메라, 돗자리, 지갑 등을 챙기면 편해.', '🏪 편의점이나 배달도 쓸 수 있으니까 너무 걱정 마!', '', '👍 필요한 준비물을 체크하면 준비가 완벽해질 거야.', '🤔 귀찮아서 안 챙기면 현장에서 조금 불편할 수도 있어.')),
(3, 1, 3, '🎉 에피소드 3. 드디어 축제 도착!', JSON_ARRAY('👨‍👩‍👧‍👦 사람들이 진짜 많아! 다들 들떠 있어.', '🎺 진해에선 군악대 퍼레이드랑 멋진 야경이 있어.', '🚚 여의도에선 푸드트럭 음식이랑 거리 공연이 인기야.', '😌 꽃밭 근처에 앉아서 여유롭게 구경하는 것도 좋아.')),
...
(1, 2, JSON_OBJECT('text', '여의도 벚꽃축제')), (1, 2, JSON_OBJECT('text', '진해 군항제')),
(2, 3, JSON_OBJECT('text', '필요한 준비물을 체크하기')), (2, 3, JSON_OBJECT('text', '귀찮으니까 난 가서 다 살래!')),
(3, 4, JSON_OBJECT('text', '진해: 군악대 퍼레이드, 야간 조명')), (3, 4, JSON_OBJECT('text', '여의도: 푸드트럭, 거리 공연')), (3, 4, JSON_OBJECT('text', '앉아서 꽃 구경하기')),
(5, 6, JSON_OBJECT('text', '도로에 나가서 손을 흔든다')), (5, 6, JSON_OBJECT('text', '전화를 반복하지 않는다')),
(6, 7, JSON_OBJECT('text', '환자의 나이와 증상을 설명한다')), (6, 7, JSON_OBJECT('text', '최대한 환자의 정보를 말한다')),
(7, 8, JSON_OBJECT('text', '조용히 동행하며 의료진 요청에 따른다')), (7, 8, JSON_OBJECT('text', '정말 필요한 질문만 한다')),
(9, 10, JSON_OBJECT('text', '119에 바로 신고한다')), (9, 10, JSON_OBJECT('text', '주변 사람들에게 119 신고를 부탁한다')),
(10, 11, JSON_OBJECT('text', '위치와 증상을 설명한다')), (10, 11, JSON_OBJECT('text', '상황을 자세히 설명한다')), (10, 11, JSON_OBJECT('text', '침착하게 구급대원의 지시를 따른다')),
(11, 12, JSON_OBJECT('text', '기본 응급처치 시도한다')), (11, 12, JSON_OBJECT('text', '구급대원에게 응급처치를 물어본다')),
(13, 14, JSON_OBJECT('text', '가까운 내과 검색')), (13, 14, JSON_OBJECT('text', '동네 약국에서 상담')), (13, 14, JSON_OBJECT('text', '그냥 집에서 쉰다')),
(14, 15, JSON_OBJECT('text', '여권과 외국인 등록증을 챙긴다')), (14, 15, JSON_OBJECT('text', '진료비를 챙긴다')), (14, 15, JSON_OBJECT('text', '번역기를 준비하여 미리 증상을 한국어로 준비한다')),
(15, 16, JSON_OBJECT('text', '문진표를 작성한다')), (15, 16, JSON_OBJECT('text', '접수대에 질문한다')),
