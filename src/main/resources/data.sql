...
INSERT INTO episode (episode_id, series_id, order_series, episode_title, episode_content) VALUES
(41, 10, 1, '🚖 에피소드 1. 목적지 설정', JSON_ARRAY('처음으로 카카오T 앱을 사용해서 택시를 불러보려고 해.', '📍 먼저 도착할 장소를 입력하고,',  '🚗 그 다음 어떤 행동을 할까?',
'차량 종류를 골라서 호출을 진행할 수도 있고,', '주소가 정확한지 다시 확인하고 수정할 수도 있어.')),
-- 1: '차량 유형 선택하기'
(42, 10, 2, '🚕 에피소드 2. 택시 호출 성공!', JSON_ARRAY('🚗 일반 택시를 선택하고 호출을 눌렀어.', '앱 화면에서 기사님 정보와 도착 예정 시간이 표시돼.',
'🚘 차량이 이동 중이고, 실시간으로 지도에서 위치를 확인할 수 있어.', '📞 필요하면 채팅이나 전화로 기사님과 연락도 가능해.')),
(43, 10, 3, '🛬 에피소드 3. 목적지 도착!', JSON_ARRAY('택시를 타고 무사히 목적지에 도착했어.', '💳 결제는 자동으로 완료되었고, 영수증도 앱에 저장돼.',
'👍 기사님 서비스는 어땠어?', '리뷰를 남길 수도 있어!')),
-- 2: '목적지를 다시 입력하기'
(44, 10, 2, '📍 에피소드 2. 주소 재확인',JSON_ARRAY('입력했던 목적지 주소가 잘못된 것 같아서 다시 입력했어.',  '정확한 건물명이나 도로명 주소를 입력하면 더 빠르게 배차돼.',
'이제 다음 단계로 넘어가보자!')),
...
-- 선택지 생성
INSERT INTO choice (episode_id, next_episode_id, choice_description) VALUES
(41, 42, JSON_OBJECT('text', '차량 유형 선택하기')), (41, 44, JSON_OBJECT('text', '목적지를 다시 입력하기')),
(42, 43, JSON_OBJECT('text', '차량 도착까지 기다리기')), (42, 43 JSON_OBJECT('text', '기사에게 메시지를 보내기')),
(44, 45, JSON_OBJECT('text', '차량 유형 선택하기')), (44, 45, JSON_OBJECT('text', '배차를 기다리기')),
(43, 46, JSON_OBJECT('text', '리뷰를 남기기')), (45, 46, JSON_OBJECT('text', '리뷰를 남기기')),
(43, 46, JSON_OBJECT('text', '리뷰 없이 종료하기')), (45, 46, JSON_OBJECT('text', '리뷰 없이 종료하기'));

-- 시리즈 11번 '🎫 예매하기' 에피소드 생성 (45, 46, 47, 48 ... 52)
INSERT INTO episode (episode_id, series_id, order_series, episode_title, episode_content) VALUES
(45, 11, 1, '🚄 에피소드 1. 기차표를 예매하자!', JSON_ARRAY('여행을 떠나기 위해 기차표를 예매하려고 해!','📱 코레일톡 앱: 스마트폰으로 간편하게 예매', '🏢 역 창구: 직접 가서 직원에게 예매',
 '🖥️ 무인 발권기: 기계로 스스로 예매 가능', '어떤 방법으로 예매할까?')),
 -- 1: 코레일톡 앱 사용하기
(46, 11, 2, '📱 에피소드 2. 앱으로 예매 중!', JSON_ARRAY('📲 앱에서 원하는 기차 시간과 좌석을 고를 수 있어.',' 📅 출발일 선택하고, 🚉 노선과 시간 체크도 잊지 마', '✅ 어떤 걸 먼저 할까?')),
(47, 11, 3, '✅ 에피소드 3. 예매 완료!', JSON_ARRAY('📧 모바일 티켓이 도착했어!',  '🚉 기차 시간에 맞춰 역으로 가자.',  '기차 타기 전에 뭐 할까?')),
 -- 2: 역 창구 방문하기
(48, 11, 2, '👨‍💼 에피소드 2. 창구에서 예매 중', JSON_ARRAY('👋 역무원에게 행선지를 말했어.', '📅 출발 날짜, 시간도 잘 설명했지!', '✅ 다음엔 어떻게 할까?')),
(49, 11, 3, '✅ 에피소드 3. 표 수령 완료!', JSON_ARRAY('🎫 종이 티켓을 받았어! 이제 플랫폼으로 향하면 돼.', '기차 타기 전에 뭐 할까?')),
 -- 3: 무인 발권기 이용하기
(50, 11, 2, '🤖 에피소드 2. 기계 앞에서 고르기', JSON_ARRAY('🧾 화면을 보며 날짜와 시간, 좌석을 선택 중이야.',
'처음 써보는 기계라 조금 낯설지만 괜찮아!', '✅ 무엇부터 해볼까?')),
(51, 11, 3, '✅ 에피소드 3. 티켓 출력 완료!', JSON_ARRAY('🖨️ 티켓이 인쇄됐어! 미션 성공!',   '기차 출발까지 시간 여유가 있어. 무얼 할까?')),
 --END
(52, 11, 4, '🚏 에피소드 4. END');

-- 선택지 생성
INSERT INTO choice (episode_id, next_episode_id, choice_description) VALUES
(45, 46, JSON_OBJECT('text', '코레일톡 앱 사용하기')), (45, 48, JSON_OBJECT('text', '역 창구 방문하기')),
(45, 50, JSON_OBJECT('text', '무인 발권기 이용하기')), (46, 47, JSON_OBJECT('text', '시간표 먼저 확인')),
(46, 47, JSON_OBJECT('text', '좌석 먼저 고르기')), (48, 49, JSON_OBJECT('text', '시간표 확인하기')),
(48, 49, JSON_OBJECT('text', '좌석 위치 묻기')), (50, 51, JSON_OBJECT('text', '노선 먼저 확인하기')),
(50, 51, JSON_OBJECT('text', '좌석부터 고르기')), (47, 52, JSON_OBJECT('text', '플랫폼 미리 찾기')),
(47, 52, JSON_OBJECT('text', '간식 사기')), (47, 52, JSON_OBJECT('text', '화장실 가기')),
(49, 52, JSON_OBJECT('text', '간식 사기')),  49, 52, JSON_OBJECT('text', '화장실 가기')),
(49, 52, JSON_OBJECT('text', '기차 사진 찍기')), (51, 52, JSON_OBJECT('text', '간식 사기')),
(51, 52, JSON_OBJECT('text', '자리에서 대기')), (51, 52, JSON_OBJECT('text', '기차 사진 찍기'));

-- 시리즈 12번 '🚄 이용 꿀팁' 에피소드 생성 (53 ... 60)
INSERT INTO episode (episode_id, series_id, order_series, episode_title, episode_content) VALUES
(53, 12, 1, '🚄 에피소드 1. 기차 이용 꿀팁 시리즈!', JSON_ARRAY('기차를 더 편리하게 타는 꿀팁 알려줄게!', '🛋️ 기차 안에서 할 일',  '🏁 내릴 때 주의할 점',  '어떤 주제부터 볼까?')),
-- 1: 기차 타기 전 준비하기
(54, 12, 2, '🎒 에피소드 2. 출발 전 준비물 체크', JSON_ARRAY('🚉 기차 타기 전에 놓치기 쉬운 준비물 체크!',  '🎫 티켓과 신분증은 물론, 핸드폰 충전 상태 확인했어?',
'🔋 보조배터리 없으면 장거리 여행 중 곤란해질 수 있어.', '🍞 간식은 기차 안에서 식사 대용으로도 좋아.',  '✅ 자, 가장 먼저 챙길 건 뭐야?')),
(55, 12, 3, '🏃 에피소드 3. 기차역에 도착!', JSON_ARRAY('⏰ 출발 20분 전 도착! 여유롭지만 할 게 많아.',  '🚻 화장실은 지금 가는 게 좋아, 기차 안은 복잡할 수 있거든.',
'🧭 플랫폼 위치도 미리 확인하면 당황하지 않아.', '🛒 편의점에서 물이나 민트도 유용할 수 있어!')),
-- 2: 기차 안에서 할 일하기
(56, 12, 2, '🎧 에피소드 2. 자리에 앉았어!', JSON_ARRAY('🚅 자리에 앉고 나면 한숨 돌릴 시간.', '🎒 짐은 선반에 잘 올렸어?',  '🎶 이어폰은 꼭 착용해서 다른 승객에게 방해되지 않게!','🌄 창밖 풍경도 놓치지 말고.')),
(57, 12, 3, '📵 에피소드 3. 조용한 기차, 조용한 배려', JSON_ARRAY('🤫 기차는 대부분 조용한 분위기야. 통화는 꼭 짧게, 조용히!', '🍱 간식 포장도 깨끗이 정리하고',
 '👩‍👩‍👧‍👦 다른 승객이 탑승할 수 있도록 짐은 통로에 두지 않기!')),
-- 3: 기차 내릴 때 주의하기
(58, 12, 2, '📍 에피소드 2. 도착 10분 전 알림!', JSON_ARRAY('📣 곧 목적지 도착! 지금이 짐 정리의 타이밍이야.', '🧳 선반에 올려둔 짐은 미리 꺼내서 내리기 편하게 해두고,',
'🧼 좌석 주변 정돈은 매너의 기본!',)),
(59, 12, 3, '🛤️ 에피소드 3. 하차 후 마무리!', JSON_ARRAY('🚉 도착! 수고했어.',  '📸 찍은 사진들을 정리하면서 여행을 되새겨봐.',
...
-- 선택지 생성
INSERT INTO choice (episode_id, next_episode_id, choice_description) VALUES
(53, 54, JSON_OBJECT('text', '기차 타기 전 준비하기')), (53, 56, JSON_OBJECT('text', '기차 안에서 할 일하기')), (53, 58, JSON_OBJECT('text', '기차 내릴 때 주의하기')),
(54, 55, JSON_OBJECT('text', '티켓부터 확인하기')), (54, 55, JSON_OBJECT('text', '간식 챙기기')),
(55, 60, JSON_OBJECT('text', '플랫폼 위치 확인하기')), (55, 60, JSON_OBJECT('text', '화장실 들르기')), (55, 60, JSON_OBJECT('text','편의점 구경하기')),
(56, 57, JSON_OBJECT('text', '음악 듣기')), (56, 57, JSON_OBJECT('text', '간식 먹기')), (56, 57, JSON_OBJECT('text', '창 밖 풍경 감상하기')),
(57, 60, JSON_OBJECT('text', '조용히 하기')), (57, 60, JSON_OBJECT('text', '자리 깨끗이 하기')), (57, 60, JSON_OBJECT('text', '다른 승객 배려하기')),
(58, 59, JSON_OBJECT('text', '짐 정리하기')), (58, 59, JSON_OBJECT('text', '좌석 주변 정돈하기')),
(59, 60, JSON_OBJECT('text', '기차 후기 작성하기')), (59, 60, JSON_OBJECT('text', '사진 정리하기')), (59, 60, JSON_OBJECT('text', '역 주변 탐방하기'));
